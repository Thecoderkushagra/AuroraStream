...
public class AdminService {
    ...
    @Transactional
    public void createCreator(SignupRequest request) {
        ...
        User creator = entityMapper.toCreatorUser(request);
        userRepository.save(creator);

        log.info("Creator created successfully with username: {}", request.username());
    }
