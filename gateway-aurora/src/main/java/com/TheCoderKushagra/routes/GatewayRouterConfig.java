...
public class GatewayRouterConfig {
    ...
    public RouterFunction<ServerResponse> userServiceRouter() {
        return RouterFunctions.route(POST("/user/auth/login").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.POST, userService, "/auth/login"))
                        .andRoute(POST("/user/auth/signup").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.POST, userService, "/auth/signup"))
                        .andRoute(POST("/user/auth/varify-otp").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.POST, userService, "/auth/varify-otp"))
                        .andRoute(POST("/user/auth/resend-otp").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.POST, userService, "/auth/resend-otp"))

                        // VIEWER
                        .andRoute(GET("user/viewer/me").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.GET, userService, "/viewer/me"))

                        // NEW CONTROLLERS
                        .andRoute(POST("/user/administrator/create-admin").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.POST, userService, "/administrator/create-admin"))
                        .andRoute(POST("/user/admin/create-creator").and(accept(MediaType.APPLICATION_JSON)),
                        request -> requestService.forwardRequest(request, HttpMethod.POST, userService, "/admin/create-creator"))
